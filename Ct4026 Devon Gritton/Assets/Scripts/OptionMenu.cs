...
public class OptionMenu : MonoBehaviour// the purpose of this script is to apply changes to the system settings based on the users settings selection in the settings menu
{
